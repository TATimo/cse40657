        ...
        for node in nodes:
            if len(node.children) > 1:
                ...
                if '*' in node.children[0].label:
                    node.children[0].label = node.children[0].label + '[' + node.children[1].label + ']'
                # for right branching
                if '*' in node.children[1].label:
                    node.children[1].label = node.children[1].label + '[' + node.children[0].label + ']'
        ...
        for node in nodes:
            if len(node.children) > 1:
                for child in node.children:
                    child.label = child.label + '[' + node.label + ']'
